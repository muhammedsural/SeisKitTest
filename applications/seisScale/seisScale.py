...
def updateTheme(fig, theme):
    if theme:
        fig['layout']['paper_bgcolor'] = 'white'
        fig['layout']['plot_bgcolor'] = 'white'
        fig['layout']['template'] = 'plotly_white'
    else:
        fig['layout']['paper_bgcolor'] = '#222222'
        fig['layout']['plot_bgcolor'] = '#222222'
...
def createResponseSpectrum(click, type, ss, s1, soil, spectrumType, lat, lon, site, contents, filename, fig, theme):
    if click is None:
        raise PreventUpdate
...
def downloadExample(click):
    csvFile = "assets/data/exampleSpectrum.csv"
...
def filterFunction(clickFilter,clickOptimum, fig, period, magnitudeRange, vs30Range, rjgRange, faultMechanism, duration575, duration595, ariasIntensity, numberOfMotions, type, ss, s1, soil, spectrumType, lat, lon, site, contents, filename, theme):
...
def performScaling(click, period, magnitudeRange, vs30Range, rjgRange, faultMechanism, duration575, duration595, ariasIntensity, numberOfMotions, type, ss, s1, soil, spectrumType, lat, lon, site, contents, filename, ordinate, shift, range, fig, theme):
    ...
    if theme:
        ...
        responseColor = "#FFFF00"
        geoMeanColor = 'orange'
        meanColor = 'cornflowerblue'
        fillColor = 'lightgray'
...
@callback(
    Output('defaultFig', 'figure'),
    Input('themeStore', 'data'),
    State('defaultFig', 'figure'),
    prevent_inital_call = True
)
def applyTheme(theme, fig):
    if theme:
        fig['layout']['paper_bgcolor'] = 'white'
        fig['layout']['plot_bgcolor'] = 'white'
        fig['layout']['template'] = 'plotly_white'
        ...
        # response color
        if fig['data']:
            fig['data'][-1]['line']['color'] = '#000080'
            fig['data'][-2]['line']['color'] = '#000080'
            fig['data'][-3]['line']['color'] = 'red'
            fig['data'][-4]['line']['color'] = 'red'
            fig['data'][-5]['line']['color'] = 'darkorange'
            fig['layout']['shapes'][0]['fillcolor'] = 'yellow'
        ...
        # response color
        if fig['data']:
            fig['data'][-1]['line']['color'] = '#FFFF00'
            fig['data'][-2]['line']['color'] = '#FFFF00'
            fig['data'][-3]['line']['color'] = 'cornflowerblue'
            fig['data'][-4]['line']['color'] = 'cornflowerblue'
            fig['data'][-5]['line']['color'] = 'orange'
            fig['layout']['shapes'][0]['fillcolor'] = 'lightgray'
